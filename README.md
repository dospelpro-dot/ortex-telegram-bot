...
**Sentiment-фильтр:** упоминания делятся на бычьи/медвежьи (native-метка
StockTwits + финансовый лексикон с обработкой отрицаний). Скор считает
*ускорение бычьего внимания* (`bull_velocity`) и долю быков (`bull_ratio`),
поэтому «shorting this / puts / rug» не раздувает сигнал наравне с «🚀 squeeze».
